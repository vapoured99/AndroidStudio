...
public class lin extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.linlithgow);
    ...
    public void CreateAlertDialogWithSwitchButton() {
        AlertDialog.Builder builder = new AlertDialog.Builder(lin.this);
