...
public class cullen extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    public void CreateAlertDialogWithSwitchButton() {
        AlertDialog.Builder builder = new AlertDialog.Builder(cullen.this);
