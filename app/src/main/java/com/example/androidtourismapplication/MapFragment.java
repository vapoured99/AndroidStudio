...
//
        ...
        googleMap.addMarker(new MarkerOptions().position(new LatLng(57.36416,-2.0728)).title("YOU").snippet("This is your location!").icon(BitmapDescriptorFactory.defaultMarker(BitmapDescriptorFactory.HUE_BLUE)));
        ...
        CameraPosition Scotland = CameraPosition.builder().target(new LatLng(56.6194291,-3.8660564)).zoom(6).bearing(0).tilt(45).build();
